...
const ICON_TEXT_SIZE = `<svg class="toolbar-icon" viewBox="0 0 24 24" aria-hidden="true"><text x="2" y="17" font-size="15" font-weight="700" fill="currentColor" font-family="system-ui, sans-serif">A</text><text x="14" y="19" font-size="10" font-weight="700" fill="currentColor" font-family="system-ui, sans-serif">a</text></svg>`;
