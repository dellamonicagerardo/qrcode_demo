const I18N = {
  it: {
    ...
    disclaimer: "Immagini di esempio a scopo dimostrativo: i prodotti reali possono differire.",
  ...
  en: {
    ...
    disclaimer: "Sample images for demonstration only; real products may differ.",
